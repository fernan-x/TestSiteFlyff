...
<div id="bodypat">
 ...
 <?php
header( "refresh:300;" ); //refreshes the data every five minutes  
...
$discord = json_decode(file_get_contents('https://discordapp.com/api/guilds/364110828623888384/widget.json'));
...
// Join button, replace https://discord.gg/rrnrPn4 with the link to your own server
print "<a href=\"https://discord.gg/HdpPequ" target=\"_blank\" class=\"div-link\"><div>Join Server</div></a><span class=\"small\"><br><br></span>";
                        ...
                        print "&nbsp;&nbsp;&nbsp;&nbsp;<img class=\"discord-avatar\" src=\"".$m->avatar_url."\">";
                            If  (isset($m->nick))  { print "&nbsp;<img class=\"discord-status\" src=\"images/".$m->status.".png\">&nbsp;&nbsp;" . $m->nick; } 
                                ...
                                $mn++; 
                                    ...
                                    switch ($m->self_mute) {
                                        case "true":
                                            print "&nbsp;<img class=\"mutedeaf\" src=\"images/mute_dark.svg\">";
                                    }
                                    switch ($m->self_deaf) {
                                        case "true":
                                            print "&nbsp;<img class=\"mutedeaf\" src=\"images/deaf_dark.svg\">";
                                    }
                                    if(isset($m->bot)) {
