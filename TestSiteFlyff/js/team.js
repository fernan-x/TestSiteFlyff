$(document).ready(function(){
  ...
  $('.a6').click(function(){
    // met la photo en couleur
    $('.a6').attr("style", "background-image:url('img/team/test.jpg');")
    // met les aurtes photos en N&b
    $('.a1').attr("style", "background-image:url('img/team/test.jpg');")
    $('.ch6').show(500);
